        ...
        <div className='pt-20'>
            ...
            <div className='max-w-350 mx-auto'>
                ...
                <div className=' grid grid-cols-3 gap-8 pt-4'>
                    {/* card */}
                    {
                        courses.slice(0, 3).map(course => <div key={course.id} className=' group bg-foreground rounded-lg shadow-sm overflow-hidden hover:shadow-lg transition-all duration-300'>
